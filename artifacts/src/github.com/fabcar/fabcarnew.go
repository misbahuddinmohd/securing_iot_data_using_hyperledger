...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	cars := []Car{
		Car{Temperature: "97", Heartrate: "170", Bp: "180/90", Spo2: "96", Patient: "test1"},
		Car{Temperature: "98", Heartrate: "175", Bp: "185/85", Spo2: "98", Patient: "test2"},
	...
	for i < len(cars) {
		...
		APIstub.PutState("PATIENT"+strconv.Itoa(i), carAsBytes)
		i = i + 1
	}
...
func (s *SmartContract) createPrivateCar(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	var car = Car{Temperature: carInput.Make, Heartrate: carInput.Model, Bp: carInput.Color, Spo2: carInput.Owner}
